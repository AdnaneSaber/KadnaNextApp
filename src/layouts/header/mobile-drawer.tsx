...
const MobileDrawer: React.FC<MobileDrawerrProps> = (me) => {
  const [dataSet, setDataSet] = React.useState({});
  const d = new Object({ fullName: me.fullName });
          ...
          <DrawerContentWrapper>
            <DrawerProfile>
              {isAuthenticated ? (
                <LoginView>
                  <UserAvatar>
                    <img src={me.image} alt={me.fullName} />
                  </UserAvatar>
                  <UserDetails>
                    <h3>{me.fullName}</h3>
                    <span>
                      {me.contactsSet ? me.contactsSet[0].number : ""}
                    </span>
                  </UserDetails>
                </LoginView>
              ) : (
